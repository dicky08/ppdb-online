    ...
    <section class="content-header">
        ...
        <div class="box">
            <div class="box-header">
                ...
                <?php else : ?>
                    <div class="alert alert-success">Selamat! Status Siswa Aktif</div>
                <?php endif; ?>
            </div>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    <?php elseif ($dp['status'] == "Sudah Bayar") : ?>
                                        <a href="" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i> Edit</a>
                                        <a href="<?= site_url('cetakPendaftaran'); ?>" class="btn btn-primary btn-sm"><i class="fa fa-print"> Cetak</i></a>
                                    <?php else : ?>
                                        <a href="<?= site_url('cetakPendaftaran'); ?>" class="btn btn-primary btn-sm"><i class="fa fa-print"> Cetak</i></a>
                                    <?php endif; ?>
                                </td>
