<div class="jumbotron jumbotron-fluid" style="background-image: url('assets/img/jess-bailey-l3N9Q27zULw-unsplash.jpg');background-size: cover;height: 850px;  background-position-y: -180px;">
	<div class="container">
		<form action="<?= site_url('user-registrasi') ?>" method="post" enctype="multipart/form-data">
			<div id="register">
				<div class="row box">
					<div class="kotak" style="background-color: whitesmoke; height: 50px;">
						<a class="btn btn-light lanjut1" style="margin-left: 10px; line-height: 30px;font-family: 'Microsoft PhagsPa'; font-weight: bold;font-size: 18px;"><i class="fa fa-arrow-circle-right"></i> 1 Langkah lagi</a>
						...
						<a class="btn btn-ligth kembali1" style="margin-left: 10px; line-height: 30px;font-family: 'Microsoft PhagsPa'; font-weight: bold;font-size: 18px;"><i class="fa fa-reply"></i> Kembali</a>
						<button type="submit" name="submit" class="btn btn-info simpan"><i class="fa fa-save"></i> Simpan</button>
					</div>
